...
$insert = $this->Shopping_cart_model->insertCustomer($custData);
...
$insertOrder = $this->Shopping_cart_model->insertOrder($ordData);
...
// Insert order items
$insertOrderItems = $this->Shopping_cart_model->insertOrderItems($ordItemData);
...
$data['order'] = $this->Shopping_cart_model->getOrder($ordID);

$this->load->view('placed_order', $data);
}
...
$insert = $this->Shopping_cart_model->insertCustomer($data);
