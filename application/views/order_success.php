    ...
    <div class="col-lg-12 item">
        <div class="col-sm-2">
            <div class="img" style="height: 75px; width: 75px;">
                <?php $imageURL = !empty($item["image"])?base_url('uploads/product_images/'.$item["image"]):base_url('assets/upload/images/logo.jpg'); ?>
...
<button><span style="text-align: center;tex"><a href="<?php echo base_url(); ?>">Home</a></span></button>
