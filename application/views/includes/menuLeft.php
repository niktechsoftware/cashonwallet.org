       ...
       <ul class="mega-menu clothing-menu">
           <li>
               <div class="row m-0">
                   ...
                   <div class="col-xl-4">
                       <a href="#" class="mega-menu-banner"><img src="<?php echo base_url(); ?>assets/images/mega-menu/fashion.jpg" alt="" class="img-fluid"></a>
                   </div>
               </div>
           </li>
       </ul>
...
<a href="<?php echo base_url();?>index.php/welcome/"> <img
src="<?php echo base_url(); ?>assets/images/icon/logo.png" class="img-fluid" alt=""></a>
</div>
</div>