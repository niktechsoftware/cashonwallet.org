    ...
    <div class="container">
        <div class="row">
           ...
           ?>     
                ...
                <div class="card">
                    <div class="card-body">
                        <form  class="theme-form" action="<?php echo base_url();?>index.php/dashboard/generate_mpin/" method="post">
                        <table class="table table Responsive">
                         
                         
                         <tr><td>
                                <label for="mpinbal" style="padding-top:10px;"><strong>Select Payment</strong></label></td>
                               <td> <select class="form-control" name="mpinbal" id="mpinbal" style="width:150px"; required="required">
                       ...
                       <td> <label for="number" style="padding-top:10px;"> <strong>Generate Mpin </strong></label> </td>
                        <td><input type="number" name="number" id="number" class="form-control" placeholder="Enter Number For Mpin"
                         style="width:150px;" required="required"/></td>
                       
                        <td><input type="submit" class="btn btn-primary btn-solid" id="subm" value="Generate" disabled="disabled"/></td>
                        </tr>
                        ...
                        <div id = "iwallet"><strong>Your Income wallet Account Balance =</strong>
                         <input type ="text" id="iwallet1" class="form-control" name ="iwallet" style="background-color:Orange; width:150px" Value="<?php echo $this->dashboard_model->totalwallet($this->session->userdata("customer_id"));?>" readonly/>
          </div>
                         <div id = "mwallet"><strong> Your M wallet Account Balance =</strong><input type ="text" class="form-control" style="background-color:Orange; width:150px" id="mwallet1" name ="iwallet" Value="<?php echo $this->dashboard_model->mwallettotal();?>" readonly/>
          </div>
          </div>
          </div>
