  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" onclick="Refresh()" aria-label="Close"><span aria-hidden="false">&times;</span></button>
        <h4 class="modal-title" id="exampleModalLabel"><span style="margin-left:-690px;color: red;">Cart details</span></h4>
      </div>
      <div class="modal-content">
      <div class="col-lg-12 col-md-12">
                ...
                <tr class="item first rowid<?php echo $data['rowid'] ?>">
                   <td class="thumb"><?php echo $i;?></td>
                  <td class="thumb">
                     <img src="<?php echo base_url(); ?>admin/assets/images/<?php echo $data['image'] ?>" alt="<?php echo $data['id'] ?>">
                  </td>
