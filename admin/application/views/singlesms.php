<div id="main-wrapper" class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="theme-form" action="<?php echo base_url(); ?>index.php/sms/single"
                        method="post">
            	<div class="panel-body">
            		<div class="row">
            			<div class="col-md-12">
                             ...
                             <div class="col-md-8 btn btn-danger"> 
                            ...
                            <div class="col-md-7">  
                            <textarea  name="msg" id="sms" class="form-control" rows="8" cols="20" > </textarea> 
                            </div> 
