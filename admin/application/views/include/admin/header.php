        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span>Cashonwallet</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="<?php echo base_url()?>apanel/changePassword"><i class="fa fa-user"></i>Profile</a></li>
