                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	...
                            	<?php $deta = $this->db->get("marquee")->row();?>
                                   <form class="form-horizontal" action="<?php echo base_url()?>apanelForms/editHeadline1" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Marquee Content</label>
                                            <div class="col-sm-10">
                                            	<textarea rows="6" cols="60" class="form-control summernote" name="content" >
                                            		<?php echo $deta->notice;?>
                                            	</textarea>
                                            </div>
                                        </div>
                                ...
                                <?php else:?>
                                	<form class="form-horizontal" action="<?php echo base_url()?>apanelForms/marquee" method="post">
                                       <!--  <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Subject</label>
                                            <div class="col-sm-10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <!--  <td><?php echo $row->subject; ?></td> -->
                                                ...
                                                <td>
                                                	<!-- <a href="<?php echo base_url();?>apanel/notice/edit/<?php echo $row->id;?>">Edit</a>  -->| 
                                                	<button class="btn btn-info"><a href="<?php echo base_url();?>apanelForms/deleteHeadline/<?php echo $row->id;?>">Delete</a></button>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
