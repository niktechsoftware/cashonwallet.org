...
function sms($contact,$comments)
{
    ...
    $url="http://bulksms.niktechsoftware.com/vendorsms/pushsms.aspx?user=cashonwallet&password=cashonwallet@123&msisdn=".$contact."&sid=CASHON&msg=".urlencode($comments)."&fl=0&gwid=2";
    $ch = curl_init();
...
{ 
$url = "http://bulksms.niktechsoftware.com/vendorsms/CheckBalance.aspx?user=cashonwallet&password=cashonwallet@123";
$ch = curl_init();
curl_setopt($ch,CURLOPT_URL,$url);
curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
$output=curl_exec($ch);
